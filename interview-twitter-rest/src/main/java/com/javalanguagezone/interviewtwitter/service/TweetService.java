...
public class TweetService {
  ...
  public long countTweetsFromUser(Principal principal) {

    /*using old way
    return tweetRepository.countTweetsByUser(principal.getName());
    */
    return tweetRepository.countTweetsByAuthor_Username(principal.getName());
  }
